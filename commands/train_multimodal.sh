...
--num_gcn_layers 1 \
--no_peft \
--run_name clip-vit-large_batch20_3e-6lr_1gcn_xuinit \
--logging online \
--target_column label \
--text_column text \
...
--num_gcn_layers 1 \
--no_peft \
--run_name clip-vit-large_batch20_8e-6lr_1gcn_xuinit \
--logging online \
--target_column label \
--text_column text \
--image_column image_path \
...
# --no_peft \
# --add_caption \
# --run_name clip-vit-large_batch64_5e-6lr_mami64bs_caption \
# --logging online \
...
# --checkpoint_path output_mami/clip-vit-large_batch64_5e-6lr \
# --model_name_or_path openai/clip-vit-large-patch14 \
